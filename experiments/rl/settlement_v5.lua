-- Experimental result-only adapter v5 candidate. Stage as rl_settlement.lua in NEW runs.
...
return function(Core)
 ...
 Core.rl_settlement_adapter='native-time-pip-and-confirmed-draw-v5'
 ...
 function Core:begin_round(s,effects)
  self.rl_time_award=nil;self.rl_time_previous=nil
