-- Corrected reference ONLY for native-time parity; original runtime.lua is unchanged.
-- Ignore frame notifiers whose emulated time has not advanced.
...
local function snapshot()
 ...
 s.emulated_seconds=m.time:as_double();s.native_frame_period=m.screens[':screen'].frame_period;s.effective_difficulty=astra_difficulty.check(level).effective_difficulty
 return s
end
